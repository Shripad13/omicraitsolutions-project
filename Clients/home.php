...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $qry=mysql_query("INSERT INTO Contact_Forms(c_name, c_email, c_contact, c_subject, c_message) VALUES ('$a', '$b', '$c', '$d', '$e')");
...
<html lang="en">
 ...
 <body>
     ...
     <!-- header design -->
     <header class="header">
         <img src="images/omi5.jpg" alt="OMICRA Logo" width="200">
